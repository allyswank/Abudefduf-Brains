...
blastfile="./Zebra_full_gene.OUT" # the name of your output table from BLAST
goinfo="Zebra_GO_terms.csv" # the name of a file containing genes and GO term info from your organism that you BLASTed against. We can get this from ENSEMBL
...
seqkit grep -v -f annotated_transcripts.txt Chromis_unannotated_contigs.fa -o Zebra_unannotated_contigs.fa
