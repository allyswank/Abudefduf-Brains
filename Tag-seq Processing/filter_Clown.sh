...
blastfile="./Clown_full_gene.OUT" # the name of your output table from BLAST
goinfo="Clown_GO_terms.csv" # the name of a file containing genes and GO term info from your organism that you BLASTed against. We can get this from ENSEMBL
...
seqkit grep -v -f annotated_transcripts.txt Steg_unannotated_contigs.fa -o Clown_unannotated_contigs.fa
